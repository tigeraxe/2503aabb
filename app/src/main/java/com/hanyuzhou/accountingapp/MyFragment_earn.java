...
public class MyFragment_earn extends Fragment implements View.OnClickListener {
    ...
    public MyFragment_earn(LinkedList<DAo> record,LinkedList<LinkedList<DAo>> subrecords ){
        this.records = record;
